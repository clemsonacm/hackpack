...
\lstinputlisting[language=c++]{./structures/set/set.cpp}
...
\lstinputlisting{./structures/set/problems/cowpens/cowpens.in}
...
\lstinputlisting{./structures/set/problems/cowpens/cowpens.out}

\subsubsection{Example Solution}
\lstinputlisting{./structures/set/problems/cowpens/cowpens.cpp}
...
\subsubsection{Sample Input}
\lstinputlisting{./structures/set/problems/union/union.in}
...
\subsubsection{Sample Output}
\lstinputlisting{./structures/set/problems/union/union.out}
...
\subsubsection{Sample Input}
\lstinputlisting{./structures/set/problems/closest/closest.in}
...
\subsubsection{Sample Output}
\lstinputlisting{./structures/set/problems/closest/closest.out}
