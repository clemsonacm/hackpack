...
\subsubsection{Sample Input}
\acmlisting[caption=Union Input, label=Union Input]{./structures/set/problems/union/union.in}
...
\subsubsection{Sample Output}
\acmlisting[caption=Union Output, label=Union Output]{./structures/set/problems/union/union.out}
...
\subsubsection{Sample Input}
\acmlisting[caption=Closest Input, label=Closest Input]{./structures/set/problems/closest/closest.in}
...
\subsubsection{Sample Output}
\acmlisting[caption=Closest Output, label=Closest Output]{./structures/set/problems/closest/closest.out}
