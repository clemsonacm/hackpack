...
\acmlisting[caption= Cross Product, label = Cross Product]{./general/computational-geometry/cross-product.cpp}
...
\acmlisting[caption = Dot Product, label = Dot Product]{./general/computational-geometry/dot-product.cpp}
...
\acmlisting[caption = Arctangent, label = Arctangent]{./general/computational-geometry/arctan.cpp}
...
\acmlisting[caption = Area of Triangle, label = Area of Triangle]{./general/computational-geometry/tri-area.cpp}
...
\acmlisting[caption = Area of Polygon, label = Area of Polygon]{./general/computational-geometry/poly-area.cpp}
...
\acmlisting[caption = Side of a Line, label = Side of a Line]{./general/computational-geometry/line-sides.cpp}
...
\acmlisting[caption = Distance from point to line in 3 Dimensions, label = Distance from point to line in 3 Dimensions]{./general/computational-geometry/point-line-dist.cpp}
...
\acmlisting[caption = Point inside Polygon, label = Point inside Polygon]{./general/computational-geometry/poly-inside.cpp}

\subsection{Polygon Convexity}
To calculate whether a polygon is convex or not.
\acmlisting[caption = Polygon Convexity, label = Polygon Convexity]{./general/computational-geometry/poly-convex.cpp}
