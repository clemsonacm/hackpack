...
\end{itemize}
\lstinputlisting[label=The Fine Print Sample Input, caption=The Fine Print Sample Input, linerange={1-3,1373-1379}]{./algorithms/kmp-string-matching/problems/fine-print/fine-print.in}
