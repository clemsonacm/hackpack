...
\end{itemize}
\lstinputlisting[label=The Fine Print Sample Input (lines omitted), caption=The Fine Print Sample Input (lines omitted), linerange={1-3,1366-1379}]{./algorithms/kmp-string-matching/problems/fine-print/fine-print.in}
