...
\end{itemize}
\lstinputlisting[label=The Fine Print Sample Input, caption=The Fine Print Sample Input]{./algorithms/kmp-string-matching/problems/fine-print/fine-print.in}
\lstinputlisting[label=The Fine Print Sample File (lines omitted), caption=The Fine Print Sample File (lines omitted), linerange={1-3,1366-1379}]{./algorithms/kmp-string-matching/problems/fine-print/fine-print-test.in}
