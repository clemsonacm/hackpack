...
\acmlisting[caption=Knapsack Input, label=Knapsack Input]{./approaches/dp/problems/knapsack/knapsack.in}
...
\acmlisting[caption=Knapsack Output, label=Knapsack Output]{./approaches/dp/problems/knapsack/knapsack.out}

\subsubsection{Sample Solution}
\acmlisting[caption=Knapsack Solution, label=Knapsack Solution]{./approaches/dp/problems/knapsack/knapsack.cpp}
...
\subsubsection{Sample Input}
\acmlisting[caption=Cowy Input, label=Cowy Input]{./approaches/dp/problems/cowy/cowy.in}
...
\end{itemize}
\subsubsection{Sample Output}
\acmlisting[caption=Cowy Output, label=Cowy Output]{./approaches/dp/problems/cowy/cowy.out}

\subsubsection{Sample Solution}
\acmlisting[caption=Cowy Solution, label=Cowy Solution]{./approaches/dp/problems/cowy/cowy.cpp}
