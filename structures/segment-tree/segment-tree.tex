...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item A single line containing two integers $t_1$ and $t_2$ representing times between which the maximum number of cows seen should be reported since the last cow's data was added.
    \end{itemize}
\end{itemize}
